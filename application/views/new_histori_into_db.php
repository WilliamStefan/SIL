...
// Insert into menu
$sql="INSERT INTO histori_penjualan(tanggal, pembeli, komponen, jumlah_komponen, harga)
VALUES ('$tanggal', '$pembeli', '$komponen', '$jumlah_komponen', '$harga')";
...
if (!mysqli_query($con, $sql)) {
	...
	echo '<div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button> <strong>Sukses!</strong> Histori penjualan'. $tanggal . ' berhasil ditambahkan</div>';
}
mysqli_close($con);
