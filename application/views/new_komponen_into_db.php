...
// Insert into menu
$sql="INSERT INTO komponen(id, nama, stok_tersedia, stok_minimal)
...
if (!mysqli_query($con, $sql)) {
	...
	echo '<div class="alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button> <strong>Sukses!</strong> Komponen dengan' . $ID . 'dan nama '. $nama .'berhasil ditambahkan</div>';
}
mysqli_close($con);
