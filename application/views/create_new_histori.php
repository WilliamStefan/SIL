				...
				<div>
					<form id="form-new-histori" class="form-horizontal" method="post" action="new_histori_into_db">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input id="form-new-histori-tanggal" type="text" name="input-tanggal" class="form-control" placeholder="yyyy-mm-dd Contoh: 2001-12-31">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">Pembeli</label>
							<div class="col-sm-5">
								<input id="form-new-histori-pembeli" type="text" name="input-pembeli" class="form-control" placeholder="Contoh: Budi">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">ID komponen</label>
							<div class="col-sm-3">
								<input id="form-new-histori-komponen" type="text" name="input-komponen" class="form-control" placeholder="Contoh: K-1">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">Jumlah</label>
							<div class="col-sm-5">
								<input id="form-new-histori-jumlah" type="number" name="input-jumlah" class="form-control" placeholder="Contoh: 100" min="1">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">Harga</label>
							<div class="col-sm-5">
								<input id="form-new-histori-harga" type="number" name="input-harga" class="form-control" placeholder="Contoh: 10000" min="0">
							</div>
						</div>
						<div class="form-group">
